...
$CONTRASENA_PREDETERMINADA = "titanius123456";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Verificar si se ingresó la contraseña predeterminada
    if ($contrasena === $CONTRASENA_PREDETERMINADA) {
        $_SESSION['user'] = 'Administrador'; // O el usuario que prefieras para la contraseña predeterminada
